                ...
                {top.map((s) => {
                    ...
                    return (
                        <li key={s.songId} className="flex items-center gap-2 text-sm">
                            ...
                            <span className="shrink-0 font-mono text-xs text-fg-muted">{s.recordLabel}</span>
                        </li>
                    );
                })}
            </ol>
